        ...
        <>
            ...
            <div className='min-h-screen'>
                ...
                <div className="text-center text-3xl md:text-5xl font-bold pt-20 flex flex-col dark:text-white">
                    Explore Topics
                    <form className="mt-7">
                        <Input name="searchBlog" value={searchText} onChange={handleSearch} className="w-10/12 md:w-6/12 mx-auto" type="text" label="Search by topic name or author" />
                    </form>
                </div>

                <div className="pt-14 pb-14 mx-4 max-w-screen-xl md:mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 hover">
                    {loading ? (
