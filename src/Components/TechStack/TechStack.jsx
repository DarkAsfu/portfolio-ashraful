const TechStack = () => {
    ...
    return (
        <div className="mb-20 mt-20">
            ...
            <div className="w-10/12 mx-auto grid grid-cols-2 md:grid-cols-5 lg:grid-cols-7 gap-4 mt-8 align-middle items-center">
                {
                    skills.map((skill, idx) => <div className="bg-[#0d948915] h-full px-8 py-6 text-center rounded-md" key={idx}>
                        <img className="w-16 mx-auto" src={skill.iconLink} alt="" />
